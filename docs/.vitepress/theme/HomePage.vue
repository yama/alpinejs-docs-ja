...
<template>
  <div class="alpine-home">
    <header class="home-header">
      ...
      <nav aria-label="メインナビゲーション"><a class="active" href="/start-here">はじめに</a><a href="/essentials/installation">エッセンシャル</a><a href="/directives/data">ディレクティブ</a><a href="/magics/el">マジック</a><a href="/globals/alpine-data">グローバル</a><a href="/plugins/mask">プラグイン</a><a href="/advanced/csp">アドバンス</a></nav>
    ...
    <main class="home-main">
      <section class="hero-card">
        ...
        <img class="hero-image hero-image-light" src="/images/alpaca-hero.png" alt="アルプスの山あいに座るアルパカのイラスト">
        <img class="hero-image hero-image-dark" src="/images/alpaca-hero-dark.png" alt="月明かりのアルプスの山あいに座るアルパカのイラスト">
      </section>
