  ...
  <div class="alpine-home">
    ...
    <main class="home-main">
      <section class="hero-card">
        ...
        <img class="hero-image hero-image-light" src="/images/alpaca-hero.jpg" alt="アルプスの山あいに座るアルパカのイラスト">
        <img class="hero-image hero-image-dark" src="/images/alpaca-hero-dark.jpg" alt="月明かりのアルプスの山あいに座るアルパカのイラスト">
      </section>
