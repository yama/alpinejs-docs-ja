...
- 公開基盤: VitePress
- 現在の翻訳済みページ: `start-here.md`, `essentials/installation.md`, `directives/data.md`, `directives/model.md`, `directives/on.md`, `directives/show.md`, `directives/text.md`, `directives/effect.md`, `directives/for.md`, `directives/cloak.md`, `directives/ignore.md`, `directives/id.md`, `directives/ref.md`, `directives/html.md`, `directives/if.md`, `directives/modelable.md`, `directives/init.md`
